...
class CreateCPCLSTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('c_p_c_l_s', function (Blueprint $table) {
            ...
            $table->string('zak_npk_fertilizer')->nullable();
            $table->string('kg_npk_fertilizer')->nullable();
            $table->string('kg_pop_fertilizer')->nullable();
            $table->string('kg_dolomit_fertilizer')->nullable();
            $table->string('ltr_phc_fertilizer')->nullable();
