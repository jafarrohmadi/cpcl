document.querySelector('.sweet-wrong').onclick = function () {
    ...
    swal({
        ...
        e ? swal('Deleted !!', 'Hey, your imaginary file has been deleted !!', 'success') : swal('Cancelled !!',
            'Hey, your imaginary file is safe !!', 'error')
    })
    ...
    swal({
        ...
        return !1 !== e && ('' === e ? (swal.showInputError('You need to write something!'), !1) : void swal('Hey !!',
            'You wrote: ' + e, 'success'))
    })
    ...
    }, function () {setTimeout(function () {swal('Hey, your ajax request finished !!')}, 2e3)})
}
