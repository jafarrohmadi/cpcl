                            ...
                            <div class="form-group {{ $errors->has('billing_progress') ? 'has-error' : '' }}">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="billing_progress[]" value="doku" @if(in_array('doku',json_decode($contract->billing_progress) )) checked @endif>Verifikasi Dokumen &
                                        Bast</label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="billing_progress[]" value="SPP" @if(in_array('SPP',json_decode($contract->billing_progress) )) checked @endif>SPP</label>
                                </div>

                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="billing_progress[]" value="SPM" @if(in_array('SPM',json_decode($contract->billing_progress) )) checked @endif>SPM</label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" name="billing_progress[]" value="SP2D" @if(in_array('SP2D',json_decode($contract->billing_progress) )) checked @endif>SP2D</label>
                                </div>
