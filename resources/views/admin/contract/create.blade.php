                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route("admin.contract.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            @endcan
                            @can('contract_addendum_number_create')
                                <div
                                    class="form-group {{ $errors->has('contract_addendum_number') ? 'has-error' : '' }}">
                                    <label for="contract_addendum_number">Nomor Addendum Kontrak</label>
                                    <input name="contract_addendum_number" id="contract_addendum_number"
                                           class="form-control"
                                           value="{{old('contract_addendum_number', '')}}" type="text">
                            ...
                            @endcan
                            @can('contract_addendum_document_create')
                                <div
                                    class="form-group {{ $errors->has('contract_addendum_document') ? 'has-error' : '' }}">
                            ...
                            @endcan
                            @can('total_kg_fertilizer_create')
