            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route("admin.cpcl.update", [$contractId, $cpcl->id]) }}" method="POST"
                            ...
                            <div class="form-group {{ $errors->has('planting_schedule') ? 'has-error' : '' }}">
                                ...
                                <select name="planting_schedule" id="planting_schedule" class="form-control">
                                    ...
                                    <option value="Januari" @if($cpcl->planting_schedule == 'Januari') selected @endif>
                                        Januari
                                    </option>
                                    <option value="Februari"
                                            @if($cpcl->planting_schedule == 'Februari') selected @endif>Februari
                                    </option>
                                    <option value="Maret" @if($cpcl->planting_schedule == 'Maret') selected @endif>
                                        Maret
                                    </option>
                                    <option value="April" @if($cpcl->planting_schedule == 'April') selected @endif>
                                        April
                                    </option>
                                    <option value="Mei" @if($cpcl->planting_schedule == 'Mei') selected @endif>Mei
                                    </option>
                                    <option value="Juni" @if($cpcl->planting_schedule == 'Juni') selected @endif>Juni
                                    </option>
                                    <option value="Juli" @if($cpcl->planting_schedule == 'Juli') selected @endif>Juli
                                    </option>
                                    <option value="Agustus" @if($cpcl->planting_schedule == 'Agustus') selected @endif>
                                        Agustus
                                    </option>
                                    <option value="September"
                                            @if($cpcl->planting_schedule == 'September') selected @endif>September
                                    </option>
                                    <option value="Oktober" @if($cpcl->planting_schedule == 'Oktober') selected @endif>
                                        Oktober
                                    </option>
                                    <option value="November"
                                            @if($cpcl->planting_schedule == 'November') selected @endif>November
                                    </option>
                                    <option value="Desember"
                                            @if($cpcl->planting_schedule == 'Desember') selected @endif>Desember
                                    </option>
                                </select>
