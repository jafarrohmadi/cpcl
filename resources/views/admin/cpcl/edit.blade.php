                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route("admin.cpcl.update", [$contractId, $cpcl->id]) }}" method="POST"
                            ...
                            @endcan
                            @can('cpcl_farmers_group_name_edit')
                            <div class="form-group {{ $errors->has('village') ? 'has-error' : '' }}">
                            ...
                            @endcan
                            @can('cpcl_chairman_farmers_group_name_edit')
                            <div
